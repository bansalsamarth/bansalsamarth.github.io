...
![](assets/images/pollster-nl/Pollster-Winner.png)
...
![](assets/images/pollster-nl/lie.gif)
...
![](assets/images/pollster-nl//true.gif)
...
![](assets/images/pollster-nl//comp-table.png)
...
![](assets/images/pollster-nl//random.gif)
...
Axis got the Bihar projection wrong because of their turnout model. [See this](https://twitter.com/vasudha_ET/status/1326494185134858245?ref_src=twsrc%5Etfw).

![](assets/images/pollster-nl/axis.png)
...
For example, Axis My India was [lauded](https://twitter.com/IndiaToday/status/1187420646109614082?ref_src=twsrc%5Etfw) for being the only one to call the Maharashtra state election right. While most pollsters projected more than a two-thirds majority for the BJP-Sena alliance, Axis had the most conservative estimate, closest to what actually happened.

![](assets/images/pollster-nl/axis-maha.png)
...
![](assets/images/pollster-nl/winner-margin-error.png)
...
![](assets/images/pollster-nl/winner-margin-table.png)

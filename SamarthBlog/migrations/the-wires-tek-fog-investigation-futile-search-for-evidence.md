...
Some part of this general bemusement is understandable. The story is written by two technology researchers — [Ayushman Kaul](https://twitter.com/KaulAyushman) is an independent security and intelligence analyst and [Devesh Kumar](https://twitter.com/onosmosis) is an engineer and data analyst who now does product work at *The Wire* — and it is stuffed to the brim with technical language, data and charts, all of which is difficult for most laypersons to grasp.
...
The three-part series ([one](https://thewire.in/tekfog/en/1.html), [two](https://thewire.in/tekfog/en/2.html), [three](https://thewire.in/tekfog/en/3.html)) had the potential to be a “high-quality investigative tech-journalism” as [one reporter called it on Twitter](https://twitter.com/neutranino/status/1479035564061966337). But the proof required is missing in this pudding, or more accurately, this *khichdi*.
...
**Three:** BJP is the best in this game. They coordinate mass Twitter postings through WhatsApp groups. Content is shared on Google docs. [Hundreds of nationwide trends](https://arxiv.org/abs/2104.13259) were manufactured throughout the 2019 election. No Tek Fog required.
...
**Q2:** How big is this TekFog project? Is this an experiment, an outpost in the vast empire that is the BJP online machinery or is it “the backbone” of this machinery, as *The Wire*[claims](https://thewire.in/tekfog/en/3.html)?
...
1. Accounts that were following or being followed by these 32 accounts.

2. Accounts that tweeted those 100 hashtags.

3. They added a “temporal” filter: “account creation date, posting patterns and levels of engagement” to identify suspicious (not human-like) accounts

The authors told me both of them have done large scale social media analysis in the past (see [this](https://www.atlanticcouncil.org/in-depth-research-reports/operation-carthage-how-a-tunisian-company-conducted-influence-operations-in-african-presidential-elections/) and [this](https://www.firstpost.com/india/massive-tweet-volumes-complex-hierarchies-coordinated-attacks-hacker-reveals-how-bjp-congress-it-cells-wage-war-on-social-media-7965121.html)) and their assumptions are watertight. “We are not looking at just one dataset. We are looking at the time of the tweet, the content of the tweet, language similarity, following networks,” Devesh told me.
...
This story can be written for and has been written for every social media platform. The [ShareChat story](https://www.hindustantimes.com/opinion/how-regional-social-media-platforms-spew-fake-news-and-get-away-with-it/story-s8Kc2s4TKfne0ZRlXNuLuM.html) I wrote for the HTis an example.
...
This one is more serious and goes beyond tech. The *Wall Street Journal*’s big break on Facebook last year which revealed that Ankhi Das, the company’s top public-policy executive had [opposed applying hate-speech rules to a BJP politician](https://www.wsj.com/articles/facebook-hate-speech-india-politics-muslim-hindu-modi-zuckerberg-11597423346), is an example. Das [stepped down](https://www.wsj.com/articles/facebook-s-top-public-policy-executive-in-india-steps-down-11603807845) following the criticism.
...
They found that a ShareChat URL — “[metabase.sharechat.com](http://metabase.sharechat.com/)" — was interacting with the server of Tek Fog.
...
What do they prove with their large scale data analysis? They prove that users first post content on ShareChat and then on other platforms like Facebook and Twitter. Here’s the key claim in [their own words](https://thewire.in/tekfog/en/1.html):
...
What? ShareChat is [clearly listed](https://thewire.in/tech/explainer-heres-what-the-tek-fog-app-can-do-and-why-you-should-care) as one of the three companies that form “the corporate-technical nexus behind Tek Fog.”

And it’s not just my “misinterpretation.” While demanding a Supreme Court intervention on Tek Fog, the [Delhi Union of Journalists wrote that ShareChat](https://www.newsclick.in/Delhi-Union-Journalists-Denounces-Tek-Fog-Demands-SC-Intervention) was “reportedly responsible for developing the [Tek Fog] app.”
...
The only thing that matters in the whole Tek Fog investigation is the “[WhatsApp hijack](https://thewire.in/tekfog/en/2.html)”. That is the only solid scoop *The Wire* has.

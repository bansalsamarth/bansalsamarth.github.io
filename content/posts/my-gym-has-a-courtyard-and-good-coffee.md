...
The programming was okay-ish. I specifically signed up for strength, only to see the workouts didn't lean heavily on that front. There was some instructor drama and pushiness to sell me bootcamps, one trainer promoting bullshit fat loss supplements on her IG, and once, after a post-run Boojee breakfast, this guy told me he paid ₹20k a month to one of the coaches for a fat loss plan—which made me go completely bonkers. And no, this didn't include meals—just consultation. Yet when I talked to him about nutrition plan, the guy had no clue.

This is the classic problem with fitness: people are vulnerable about their bodies, and they trust you with that vulnerability. There is a massive information asymmetry, and someone always finds a way to exploit it. But studios are supposed to be different: they sell community alongside fitness, which makes the trust violation feel even worse.
